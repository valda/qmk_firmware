...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      | Reset|RGB Tg| HUE+ | SAT+ | VAL+ |             | Mac  |XXXXXX|XXXXXX|XXXXXX| PrScr|  Del |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |RGBRST| MODE | HUE- | SAT- | VAL- |             | Win  |Qwerty|XXXXXX|XXXXXX|XXXXXX|  Ins |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, QK_BOOT, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,                   AG_NORM, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, KC_DEL, \
